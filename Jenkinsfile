  ...
  stages {
    ...
    stage('Run health check in dev') {
      ...
      steps {
        ...
        sh "sed -i 's/PORT_TO_REPLACE/8080/' $WORKSPACE/test/neoload/user_neoload.yaml"
        ...
        sh "sed -i 's,OUTPUTFILE_TO_REPLACE,$WORKSPACE/infrastructure/sanitycheck.json,' $WORKSPACE/test/neoload/user_neoload.yaml"
          ...
          script {
              ...
              neoloadRun executable: '/home/neoload/neoload/bin/NeoLoadCmd',
                      ...
                      commandLineOption: "-project $WORKSPACE/test/neoload/user_neoload.yaml -nlweb -L BasicCheck=$WORKSPACE/infrastructure/infrastructure/neoload/lg/remote.txt -L Population_Dynatrace_Integration=$WORKSPACE/infrastructure/infrastructure/neoload/lg/local.txt -nlwebToken $NLAPIKEY -variables host=${env.APP_NAME},port=8080",
         ...
         sh "sed -i 's,OUTPUTFILE_TO_REPLACE,$WORKSPACE/infrastructure/sanitycheck.json,' $WORKSPACE/test/neoload/user_neoload.yaml"
          ...
          script {
              neoloadRun executable: '/home/neoload/neoload/bin/NeoLoadCmd',
                      ...
                      commandLineOption: "-project $WORKSPACE/test/neoload/user_neoload.yaml -nlweb -L  Population_Dynatrace_SanityCheck=$WORKSPACE/infrastructure/infrastructure/neoload/lg/local.txt -variables host=${env.APP_NAME},port=8080 -nlwebToken $NLAPIKEY ",
      ...
      steps {
          ...
          script {
              neoloadRun executable: '/home/neoload/neoload/bin/NeoLoadCmd',
                      ...
                      commandLineOption: "-project  $WORKSPACE/test/neoload/user_neoload.yaml -nlweb -L UserLoad=$WORKSPACE/infrastructure/infrastructure/neoload/lg/remote.txt -L Population_Dynatrace_Integration=$WORKSPACE/infrastructure/infrastructure/neoload/lg/local.txt -nlwebToken $NLAPIKEY -variables host=user,port=8080",
